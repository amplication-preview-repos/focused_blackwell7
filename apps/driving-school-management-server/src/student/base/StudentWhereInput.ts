...
import { CalendarEventListRelationFilter } from "../../calendarEvent/base/CalendarEventListRelationFilter";
...
class StudentWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => CalendarEventListRelationFilter,
  })
  @ValidateNested()
  @Type(() => CalendarEventListRelationFilter)
  @IsOptional()
  @Field(() => CalendarEventListRelationFilter, {
    nullable: true,
  })
